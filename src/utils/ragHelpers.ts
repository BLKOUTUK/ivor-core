...
export function getUserCommunicationStyle(conversationMemory: any[]): string {
...
export function getUserSupportNeeds(conversationMemory: any[]): string[] {
...
export function detectEmotionalState(message: string): 'calm' | 'stressed' | 'excited' | 'overwhelmed' | 'joyful' | 'uncertain' {
  const lowerMessage = message.toLowerCase()
...
export function detectFormality(message: string): 'formal' | 'casual' | 'mixed' {
