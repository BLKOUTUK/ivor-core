// Journey-Aware Knowledge System Types
// Supporting UK Black queer liberation through intelligent context understanding
...
export type UrgencyLevel = 
  ...
  | 'medium'       // Important, within days
  | 'low'          // General inquiry

export type CommunityConnectionLevel =
  | 'isolated'     // Limited community connections
  | 'exploring'    // Beginning to explore community
  | 'connected'    // Some community connections
  | 'networked'    // Well-connected in community
  | 'organizing'   // Leading/organizing in community
