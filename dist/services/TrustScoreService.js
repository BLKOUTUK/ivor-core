...
class TrustScoreService {
    constructor() {
        ...
        this.cacheExpiryHours = 24; // Cache URL validation for 24 hours
    }
    /**
     ...
     */
    async calculateKnowledgeTrustScore(entry) {
     ...
     */
    async calculateResourceTrustScore(resource) {
        ...
        const culturalScore = ((resource.culturalCompetency.blackSpecific ? 0.1 : 0) +
     ...
     */
    getTrustScoreInterpretation(score) {
        if (score >= 0.8) {
            return {
                level: 'high',
     ...
     */
    async validateMultipleUrls(urls) {
     ...
     */
    isCacheValid(checkedAt, now = new Date()) {
