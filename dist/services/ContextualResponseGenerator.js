...
exports.ContextualResponseGenerator = void 0;
const UKKnowledgeBase_js_1 = __importDefault(require("./UKKnowledgeBase.js"));
/**
...
class ContextualResponseGenerator {
    constructor() {
        this.knowledgeBase = new UKKnowledgeBase_js_1.default();
    }
    /**
     * Generate journey-aware response with specific resources and information
     */
    generateResponse(userInput, journeyContext, topic) {
     ...
     */
    getRelevantResources(journeyContext, topic) {
        ...
        const resources = this.knowledgeBase.getResourcesByStageAndLocation(stage, location, urgencyLevel, topic);
        ...
        const unique = combined.filter((resource, index, array) => array.findIndex(r => r.id === resource.id) === index);
        return unique;
    }
    /**
     * Get relevant knowledge entries
     */
    getRelevantKnowledge(userInput, journeyContext, topic) {
        ...
        const isHealthQuery = healthKeywords.some(keyword => userInput.toLowerCase().includes(keyword));
        if (isHealthQuery) {
     ...
     */
    generateContextualMessage(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateCrisisResponse(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateStabilizationResponse(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateGrowthResponse(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateCommunityHealingResponse(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateAdvocacyResponse(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateDefaultResponse(userInput, journeyContext, resources, knowledge) {
     ...
     */
    generateNextStageGuidance(journeyContext) {
     ...
     */
    requiresFollowUp(journeyContext) {
...
exports.ContextualResponseGenerator = ContextualResponseGenerator;
exports.default = ContextualResponseGenerator;
//# sourceMappingURL=ContextualResponseGenerator.js.map